export default function AdminHome(){
  return <main style={S.main}>
    <section style={S.hero}>
      <span style={S.kicker}>ESPACE CLUB · PERFORMANCE</span>
      <h1 style={S.h1}>Centre de gestion</h1>
      <p style={S.p}>Choisis ton espace. L’identité de ton organisation reste prioritaire, avec HDY comme moteur technologique en arrière-plan.</p>
    </section>
    <section style={S.grid}>
      ...
      <a href='/admin/sport' style={S.card}><span style={S.tag}>SPORT & PERFORMANCE</span><h2>Sport & Performance</h2><p>Séances, tests, monitoring Hooper/RPE/douleur, GPS, analyse et comparateur.</p><b>Entrer →</b></a>
    </section>
