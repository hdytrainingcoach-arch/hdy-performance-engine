...
export default function LabHub(){
 const cards=[
  ...
  {href:'/admin/sport/lab/sprint',title:'Sprint (chrono vidéo)',desc:'Suivi automatique du coureur (vitesse de pointe + splits 5/10/20/30/40 m) ou portillon vidéo manuel.'},
  {href:'/admin/sport/lab/cod',title:'5-0-5 · Changement de direction',desc:'Suivi automatique aller-retour sur la ligne de chronométrage — sans portillon ni cellule.'},
