...
export default function EliteInstall(){
  ...
  return <main style={S.main}>
    ...
    <section className='brandLandingIdentity' aria-label='HDY Elite'>
      <BrandLogo brand='elite' variant='hero'/>
      <p className='brandLandingEyebrow' style={{color:'#A1A1AA'}}>INDIVIDUAL PERFORMANCE</p>
      <strong className='brandLandingTitle'>HDY ELITE</strong>
      <span className='brandLandingSub'>Monitoring · Performance · Data</span>
    ...
    <section style={S.dock}>
      <p style={S.kicker}>ESPACE JOUEUR · ACCOMPAGNEMENT INDIVIDUEL</p>
      <a href='/?app=elite' style={S.button}>Entrer dans mon espace HDY Elite <span>→</span></a>
