...
export default function DiambarsInstall(){
  ...
  return <main style={S.main}>
    ...
    <section className='brandLandingIdentity' aria-label='Diambars FC'>
      <BrandLogo brand='diambars' variant='hero'/>
      <p className='brandLandingEyebrow' style={{color:'#FF343C'}}>CELLULE PERFORMANCE</p>
      <strong className='brandLandingTitle'>DIAMBARS FC</strong>
      <span className='brandLandingSub'>Performance · Monitoring · Médical · Suivi joueur</span>
      <div className='brandLandingTagline'>POWERED BY HDY PERFORMANCE ENGINE</div>
    </section>
